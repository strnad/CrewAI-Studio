    ...
    def draw(self):
        ...
        for result in filtered_results:
            ...
            with st.expander(expander_title, expanded=False):
                ...
                with col1:
                    if st.button(t('common.delete'), key=f"delete_{result.id}"):
                ...
                with col2:
                    ...
                    if st.button(t('results.open_printable'), key=f"print_{result.id}"):
                        js = f"""
                        <script>
                    ...
                    if formatted_tasks_result != "":
                        ...
                        if st.button(t('results.open_complete_printable'), key=f"print_full_{result.id}"):
                            js = f"""
                            <script>
                                var printWindow = window.open('', '_blank');
