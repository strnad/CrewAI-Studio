...
from bend.api import health, crews, agents, tasks, tools, knowledge, users, workspaces
...
app.include_router(knowledge.router, prefix=f"{settings.api_prefix}/knowledge", tags=["Knowledge Sources"])
